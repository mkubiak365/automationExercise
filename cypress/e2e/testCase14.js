...
describe('Test Case 14: Place Order: Register while Checkout', function() {
    ...
    it('Test Case 14', function() {
        ...
        cart.getRegisterLoginButton().click();
        ...
        checkOut.getCityStateZipCodeDelivery().should('contains.text', city + ' ' + state);
        checkOut.getCityStateZipCodeDelivery().should('contains.text', zipCode);
        ...
        checkOut.getCityStateZipCodeBilling().should('contains.text', city + ' ' + state);
        checkOut.getCityStateZipCodeBilling().should('contains.text', zipCode);
